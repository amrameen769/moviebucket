...
<header class="sticky-top">
    <nav id="nav-bar" class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="https://www.moviebucket.com"><img
          ...
          <?php
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" role="presentation" href="<?= SITE_URL ?>mv-theater/index.php?logout='1'"><i
            ...
            <?php elseif ($_SESSION['user_type'] == "admin") : ?>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                        ...
                        <a class="dropdown-item" role="presentation" href="#"><i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Activity log</a>-->
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" role="presentation" href="<?= SITE_URL ?>mv-admin/index.php?logout='1'"><i
                                    class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Logout</a>
                    </div>
                </div>
            <?php elseif ($_SESSION['user_type'] == "enduser") : ?>
                ...
                <form class="form-inline my-2 my-lg-0" action="<?=SITE_URL."mv-enduser/index.php"?>" method="post">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" role="presentation"
                           href="<?= SITE_URL ?>mv-enduser/index.php?logout='1'"><i
                                    class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Logout</a>
                    </div>
                </div>
            <?php endif ?>
