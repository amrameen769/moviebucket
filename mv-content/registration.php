...
<div id=center class="container-fluid">
    <div class="col- col-sm col-md col-lg col-xl containera animated fadeInUp delay-02s"
         style="background: url(../mv-includes/images/user-bg.jpg) left top repeat !important;">
        <div class="login_contain animated fadeInDown delay-02s">
            <form class="login" method="post">
                ...
                <a href="../index.php"><img id="logo" src="../mv-includes/images/mvbucket.png"
                                            alt="MovieBucket.com"></a><br>
                ...
                if (isset($_POST['signup'])) {
                    ...
                    if (empty($user_pasd_1)) {
                        array_push($errors, "Password required");
                    }
                    if (empty($user_mail)) {
                        array_push($errors, "Email required");
                    }
                    if ($user_pasd_1 != $user_pasd_2) {
                    ...
                    if (count($errors) == 0) {
                        ...
                        $formArray = array("username" => $user_uname, "password" => $user_pasd_1, "email" => $user_mail);
                    ...
                    if (count($errors) == 0) {
                        $mailer = $user_mail;
                        $sub = "Verify Your Email - Click the Below Link";
                        $hash = mysqli_real_escape_string($dbconn, md5($user_uname . rand(0, 1500)));
                        $psd = md5($user_pasd_1);
                        $regquery = "INSERT INTO tbl_user (user_name,user_uname,user_pasd,user_mail,user_phone,user_type,hash)
                ...
                <div class="inp">
                    ...
                    <input type="email" name="user_mail" placeholder="Email ID"
                           value="<?php echo $user_mail; ?>"><br><br>
                    <input type="number" name="user_phone" placeholder="Mobile"
                           value="<?php echo $user_phone; ?>"><br><br>
                    <input type="username" name="user_uname" placeholder="Enter Username"
                           value="<?php echo $user_uname; ?>"><br><br>
                    <input type="password" name="user_pasd_1" placeholder="Enter Password"
                           value="<?php echo $user_pasd_1; ?>"><br><br>
