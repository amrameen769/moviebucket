...
<html lang="en" dir="ltr">
  <head>
    ...
    <script type="text/javascript" src="<?=BASE_URL?>mv-includes/bootstrap/js/bootstrap.js"></script>
    <link rel="stylesheet" href="<?=BASE_URL?>mv-includes/css/bootstrap.css">
    <link rel="stylesheet" href="<?=BASE_URL?>mv-includes/css/master.css">
      ...
      <div class="maze animated fadeInDown delay-02s">
        <div class="container">
  			<figure class="logo animated fadeInDown delay-02s">
  				<a href="#"><img src="<?=BASE_URL?>mv-includes/images/mvbucket.png" alt="moviebucket.com"></a>
  			</figure>
  			...
  			<a class="link animated fadeInUp delay-04s servicelink" href="<?=BASE_URL?>mv-content/login.php">Login</a>
            <a class="link animated fadeInUp delay-04s servicelink" href="<?=BASE_URL?>mv-content/registration.php">SignUp</a>
  		</div>
    </div>
    </section>
  </div>
