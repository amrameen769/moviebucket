...
<header class="sticky-top">
    <nav id="nav-bar" class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        <a class="navbar-brand" href="https://www.moviebucket.com"><img src="<?=SITE_URL?>mv-includes/images/mvbucket.ico" alt="MovieBucket">MovieBucket.com</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <?php if(isset($_SESSION['user_type'])) {
                        if($_SESSION['user_type'] == 'enduser'){
                            echo SITE_URL."mv-enduser/index.php";
                        }
                        elseif($_SESSION['user_type'] == 'admin'){
                            echo SITE_URL."mv-admin/index.php";
                        }
                        elseif($_SESSION['user_type'] == 'theater'){
                            echo SITE_URL."mv-theater/index.php";
                        }
                ...
                <?php if($_SESSION['user_type'] == "admin") : ?>
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu shadow dropdown-menu-right animated--grow-in" role="menu">
                            ...
                            <div class="dropdown-divider"></div><a class="dropdown-item" role="presentation" href="<?=SITE_URL?>mv-admin/index.php?logout='1'"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i>&nbsp;Logout</a>
                        </div>
                    </div>
                <?php endif ?>
            <?php endif ?>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="width: auto!important;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="<?=SITE_URL?>mv-admin/index.php"><span>Statistics</span></a></li>
