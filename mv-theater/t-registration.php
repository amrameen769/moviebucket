...
<div id=center class="container-fluid">
    <div class="col- col-sm col-md col-lg col-xl containera animated fadeInUp delay-02s"
         style="background: url(../mv-includes/images/thr-bg.jpg) left top repeat !important; width: 1200px;height: 600px;">
        <div class="login_contain animated fadeInDown delay-02s" style="width: 780px!important;">
            <form class="login" method="post">
                ...
                if (isset($_POST['signup'])) {
                    ...
                    if (empty($thr_name)) {
                        array_push($errors, "Theater Name required");
                    }
                    if (empty($thr_uname)) {
                        array_push($errors, "Theater Username required");
                    }
                    if (empty($thr_pasd_1)) {
                    ...
                    if (empty($thr_screens)) {
                        array_push($errors, "Number of Screens required");
                    }
                    ...
                    if ($theater) {
                        if ($theater['thr_uname'] === $thr_uname) {
                            array_push($errors, "Theater Username Already Exists");
                        }
                        if ($theater['thr_mail'] === $thr_mail) {
                    ...
                    if (count($errors) == 0) {
                        $user_name = $thr_name;
                        $mailer = $thr_mail;
                        //echo $mailer." Register";
                        $sub = "Verify Your Email - Click the Below Link";
                        $hash = mysqli_real_escape_string($dbconn, md5($thr_uname . rand(0, 1500)));
                        $psd = md5($thr_pasd_1);
                ...
                <div class="inp" style="width: 100%;">
                    ...
                    <input type="username" name="thr_uname" placeholder="Enter Username"
                           value="<?= $thr_uname ?>"><br><br>
                    <input type="password" name="thr_pasd_1" placeholder="Enter Password"
                           value="<?= $thr_pasd_1 ?>"><br><br>
                ...
                <br>
                <button class="btn_signup" type="submit" name="signup">Signup</button>
                <br>
