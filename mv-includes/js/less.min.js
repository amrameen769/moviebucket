...
!function (a) {
    ...
    return function a(b, c, d) {
        ...
        29: [function (a, b, c) {
            var d = a("../tree/comment"), e = a("../tree/dimension"), f = a("../tree/declaration"),
                g = a("../tree/expression"), h = a("../tree/ruleset"), i = a("../tree/selector"),
                j = a("../tree/element"), k = a("./function-registry"), l = function (a) {
        ...
        87: [function (a, b, c) {
            ...
            i.prototype = new d, i.prototype.type = "VariableCall", i.prototype.eval = function (a) {
                ...
                if (!c.ruleset) {
                    if (c.rules) b = c; else if (Array.isArray(c)) b = new f("", c); else {
            ...
            var d = function () {
                ...
                function b(c, d, e, f, i) {
                    function l(c, e) {
                        ...
                        if (a(c, h)) p = new h; else if (a(c, j)) p = new j; else if (a(c, k)) p = new k(function (a, b) {
                            c.then(function (b) {
                                a(l(b, e - 1))
                            }, function (a) {
                                b(l(a, e - 1))
                            })
                        }); else if (b.__isArray(c)) p = []; else if (b.__isRegExp(c)) p = new RegExp(c.source, g(c)), c.lastIndex && (p.lastIndex = c.lastIndex); else if (b.__isDate(c)) p = new Date(c.getTime()); else {
